//! Windissect-generated Rust FFI bindings for AppXDeploymentClient.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "924E29C9A98AB1A3129777F274A22253";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 3710971973;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 25] = [65, 112, 112, 88, 68, 101, 112, 108, 111, 121, 109, 101, 110, 116, 67, 108, 105, 101, 110, 116, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 3710971973 { return 0; }
