...
static constexpr wchar_t module_name[25] = {0x0041, 0x0070, 0x0070, 0x0058, 0x0044, 0x0065, 0x0070, 0x006C, 0x006F, 0x0079, 0x006D, 0x0065, 0x006E, 0x0074, 0x0043, 0x006C, 0x0069, 0x0065, 0x006E, 0x0074, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 3710971973U || rva >= image_size) return nullptr;
return base + rva;
}
