...
// Reconstructed from AppXDeploymentClient.dll by Windissect. 94 member(s).
...
public:
    ...
    // Category: Accessor | Source: PDB Internal
    // Symbol: ?GetTotalChanges@Database@StateRepository@@QEBAHXZ
    ...
    // Category: Accessor | Source: PDB Internal
    // Symbol: ?IsCheckpointThresholdExceeded@Database@StateRepository@@QEAAJPEA_NPEBDPEB_KPEA_K@Z
    long IsCheckpointThresholdExceeded(bool *, char const *, uint64_t const *, uint64_t *);
    // Category: Accessor | Source: PDB Internal
