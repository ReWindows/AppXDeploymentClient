...
public:
    ...
    // Category: Method | Source: PDB Internal
    // Symbol: ?AddArrayOfMap@Writer@DictionarySerialization@StateRepository@@QEAAJPEBGW4DataType@23@_KPEBV123@@Z
    long AddArrayOfMap(unsigned short const *, int, uint64_t, WindissectOpaque const *);
    // Category: Method | Source: PDB Internal
    ...
    // Symbol: ??0Writer@DictionarySerialization@StateRepository@@QEAA@XZ
    Writer();
    // Category: Dtor | Source: PDB Internal
    // Symbol: ??1Writer@DictionarySerialization@StateRepository@@QEAA@XZ
    ~Writer();
private:
    // Category: Accessor | Source: PDB Internal
