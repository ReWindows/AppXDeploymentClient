...
public:
    ...
    // Symbol: ?GetDwordRegValue@StateSeparation@Common@@SAJAEBUStateSeparationRedirectionMapping@2@PEAPEBG_KPEBGKPEAK@Z
    static long GetDwordRegValue(WindissectOpaque const &, unsigned short const * *, uint64_t, unsigned short const *, unsigned long, unsigned long *);
    // Category: Accessor | Source: PDB Internal
